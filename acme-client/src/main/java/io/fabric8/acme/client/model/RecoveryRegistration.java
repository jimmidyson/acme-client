...
// See https://ietf-wg-acme.github.io/acme/#account-recovery for details
...
public class RecoveryRegistration extends BaseResource {
  ...
  public RecoveryRegistration(Map<String, String> contact, String base) {
    super(ResourceType.RECOVER_REGISTRATION);
