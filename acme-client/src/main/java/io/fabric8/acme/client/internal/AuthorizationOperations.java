...
public class AuthorizationOperations extends BaseOperations<Authorization> implements Creatable<Authorization, NewAuthorization, SendableNewAuthorization> {
