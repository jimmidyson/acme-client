...
public class AuthorizationTest extends BaseTest {
  ...
  public void testReadyChallenge() throws Exception {
    ...
    Dns01Challenge challenge = (Dns01Challenge) client.challenges().use(authz.getCombinations().get(0).get(0)).ready();
    assertNotNull(challenge);
    assertEquals(server.url("/acme/challenge/abcde/1234").toString(), challenge.getUri());
    assertEquals("qwerty." + jwkThumb.toString(), challenge.getKeyAuthorization());
  }
  ...
  public void testReadyAtChallenge() throws Exception {
    ...
    Dns01Challenge challenge = (Dns01Challenge) client.challenges().at(authz.getCombinations().get(0).get(0).getUri()).ready();
    assertNotNull(challenge);
    assertEquals(server.url("/acme/challenge/abcde/1234").toString(), challenge.getUri());
    assertEquals("qwerty." + jwkThumb.toString(), challenge.getKeyAuthorization());
  }
  ...
  @Test
  public void testPrepareChallenge() throws Exception {
    KeyPairGenerator kpg = KeyPairGenerator.getInstance("RSA");
    kpg.initialize(2048);
    KeyPair keyPair = kpg.generateKeyPair();
    JWK jwk = JWKUtils.jwkFromPublicKey(keyPair.getPublic());
    ...
    Dns01Challenge challenge = (Dns01Challenge) client.challenges().use(authz.getCombinations().get(0).get(0)).prepare();
    assertNotNull(challenge);
    assertEquals(server.url("/acme/challenge/abcde/1234").toString(), challenge.getUri());
    assertEquals("qwerty." + jwkThumb.toString(), challenge.getKeyAuthorization());
  }
  ...
  @Test
  public void testPrepareAtChallenge() throws Exception {
    KeyPairGenerator kpg = KeyPairGenerator.getInstance("RSA");
    kpg.initialize(2048);
    KeyPair keyPair = kpg.generateKeyPair();
    JWK jwk = JWKUtils.jwkFromPublicKey(keyPair.getPublic());
    ...
    Dns01Challenge challenge = (Dns01Challenge) client.challenges().at(authz.getCombinations().get(0).get(0).getUri()).prepare();
    assertNotNull(challenge);
    assertEquals(server.url("/acme/challenge/abcde/1234").toString(), challenge.getUri());
    assertEquals("qwerty." + jwkThumb.toString(), challenge.getKeyAuthorization());
  }
